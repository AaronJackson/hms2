...
return [
    ...
    */
    'features' => [
        ...
        'printers' => env('FEATURE_PRINTERS', false),
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'team_slack_webhook' => env('TEAM_SLACK_WEBHOOK', false),
    'trustees_slack_webhook' => env('TRUSTEE_SLACK_WEBHOOK', false),
    ...
    |--------------------------------------------------------------------------
    */
    'printers_key' => env('PRINTERS_KEY', null),
